...
$(document).ready(function() {
    ...
    $(".order").click(function(){
        console.log($("input[name='order[]']").length);
        if($("input[name='order[]']:checked").length === $("input[name='order[]']").length){
    ...
    $("#selectCartSend").click(function(){
        ...
        $.ajax({
        	...
        	console.log(data);
        	if(paramList.length == data){
        		location.href='/main/payment';
        	} else {
        		alert("전산 처리 중 오류 발생 하였습니다. \n 경민이에게 물어 보세요.");
        	}
        });
